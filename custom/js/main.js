...
var PointType = ['ATM','Tree','Telephone Poles', 'Electricity Poles', 'Other'];
var LineType = ['National Highway','State Highway','River','Telephone Lines','Other'];
var PolygonType = ['Water Body','Commercial Land', 'Residential Land','Building','Other'];
